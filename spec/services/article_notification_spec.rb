...
RSpec.describe ArticleNotification do
  describe '#send' do
    ...
    before do
      ...
      allow_any_instance_of(ArticleNotification).to receive(:construct_notification_from_params).with(data).and_return(notification)
    ...
    it 'sends a notification to the News-v2 topic' do
      ...
      ArticleNotification.new(data).send
    end
