    ...
    describe '#create' do
      context 'when firm exists' do
        it 'creates a new rating' do
          expect do
            post "/api/firms/#{firm.id}/ratings", params: { rating: { value: 4, comment: "very good" } }, headers: headers
      ...
      context 'invalid params' do
        it 'returns unprocessable_entity status' do
          expect do
            post "/api/firms/#{firm.id}/ratings", params: { rating: { value: nil } }, headers: headers
